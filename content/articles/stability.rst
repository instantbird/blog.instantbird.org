...
.. |Instantbird Crash Reporter dialog| image:: http://blog.instantbird.org/images/crash-breakpad.png
.. |Account manager with automatic connection disabled and an error message explaining the problem| image:: http://blog.instantbird.org/images/autologin-crash-global.png
.. |Account manager where an account was disabled because of a crash during the last connection attempt.| image:: http://blog.instantbird.org/images/autologin-crash-account.png
.. |Dialog prompting the user to accept a security and stability update| image:: http://blog.instantbird.org/images/update1.png
.. |Check for updates menu item| image:: http://blog.instantbird.org/images/update6.png
.. |About dialog of a Nightly build of Instantbird| image:: http://blog.instantbird.org/images/nightly2.png
