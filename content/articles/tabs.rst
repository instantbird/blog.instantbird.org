...
.. |Top of conversation window with 2 tabs and some free space| image:: http://blog.instantbird.org/images/tabs1-2tabsandfreespace.png
.. |Top of conversation window with 4 tabs, only one close button is displayed| image:: http://blog.instantbird.org/images/tabs2-4tabs1closebutton.png
.. |Top of conversation window with overflowing tabs, and the all tabs menu opened| image:: http://blog.instantbird.org/images/tabs3-overflowandalltabsmenu.png
.. |Very small conversation window with 2 tabs| image:: http://blog.instantbird.org/images/tabs4-smallwindow.png
.. |dragging a tab, tab drop arrow visible in the same window| image:: http://blog.instantbird.org/images/tabs5-reorder.png
.. |new window with only one tab| image:: http://blog.instantbird.org/images/tabs6-detach.png
.. |dragging a tab, drop arrow visible in another window| image:: http://blog.instantbird.org/images/tabs7-movebetweenwindows.png
.. |An active and an inactive conversation window on Mac OS X| image:: http://blog.instantbird.org/images/tabs8-macosxactiveinactive.png
